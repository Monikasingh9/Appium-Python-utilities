# This Function puts the Call B on hold and accepts call C

def accept_incoming_call_c_hold_ongoing_call_b(device):
    ...
    if verify is True:
        logging.info('New call accepted and previous call has been put on hold')
    else:
        logging.error('Previous call could not be put on hold')
